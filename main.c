...
//team red
#define GPIO_LED_RED 74

//team blue
#define GPIO_LED_BLUE 74
...
char lock0 = 0; 
void PWM0(int pwm_number,int period,int duty_cycle,int status) {
